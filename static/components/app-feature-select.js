...
class AppFeatureSelect extends LitElement {
  ...
  // Initialize displayed features for first tab
  ...
  render() {
    return html`<div class="app-feature-select">
      ...
      <div id="REPLACEMENT" class="tabcontent">
        <section>
          ${(() => {
            this.filterFeatures("REPLACEMENT");
            return this.displayedFeatures.map(
              (feature) => html`
                <div>
                  <input
                    type="checkbox"
      ...
      <div id="IDENTIFICATION" class="tabcontent">
        <section>
          ${(() => {
            this.filterFeatures("IDENTIFICATION");
            return this.displayedFeatures.map(
              (feature) => html`
                <div>
                  <input
